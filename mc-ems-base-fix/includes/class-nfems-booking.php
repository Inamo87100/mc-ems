        ...
        <div id="prenotazione-esame" style="max-width: 640px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9;">
            ...
            <?php else: ?>
                ...
                <div id="nfems-booking-calendar-wrap" style="display:none; margin-bottom:20px;">
                    <label style="font-weight:bold; display:block; margin-bottom:8px;">Choose a date:</label>
                    <div style="display:flex; justify-content:center; align-items:center; gap:10px; margin-bottom:10px;">
                        <button type="button" id="nfems-prev-month" style="background:none; border:none; font-size:20px; cursor:pointer; padding:5px 8px; border-radius:50%;">&larr;</button>
                        <span id="nfems-month-year" style="font-weight:700; font-size:18px; text-transform:capitalize;"></span>
                        <button type="button" id="nfems-next-month" style="background:none; border:none; font-size:20px; cursor:pointer; padding:5px 8px; border-radius:50%;">&rarr;</button>
                    </div>

                    <div style="display:grid; grid-template-columns:repeat(7,1fr); max-width:520px; margin:0 auto 4px; gap:4px;">
                        <div style="text-align:center; font-weight:700; font-size:13px; padding:4px 0;">Mon</div>
                        <div style="text-align:center; font-weight:700; font-size:13px; padding:4px 0;">Tue</div>
                        <div style="text-align:center; font-weight:700; font-size:13px; padding:4px 0;">Wed</div>
                        <div style="text-align:center; font-weight:700; font-size:13px; padding:4px 0;">Thu</div>
                        <div style="text-align:center; font-weight:700; font-size:13px; padding:4px 0;">Fri</div>
                        <div style="text-align:center; font-weight:700; font-size:13px; padding:4px 0;">Sat</div>
                        <div style="text-align:center; font-weight:700; font-size:13px; padding:4px 0;">Sun</div>
                    </div>

                    <div id="nfems-booking-calendar" style="display:grid; grid-template-columns:repeat(7,1fr); max-width:520px; margin:0 auto; gap:4px;"></div>

                    <div style="display:flex; flex-wrap:wrap; justify-content:center; gap:10px; margin:12px auto 0; font-size:12px; color:#555;">
                        <span style="display:inline-flex; align-items:center; gap:6px;">
                            <span style="width:12px; height:12px; border-radius:50%; background:#4caf50; display:inline-block;"></span>
                            High availability
                        </span>
                        <span style="display:inline-flex; align-items:center; gap:6px;">
                            <span style="width:12px; height:12px; border-radius:50%; background:#ffeb3b; display:inline-block; border:1px solid #d4c600;"></span>
                            Medium availability
                        </span>
                        <span style="display:inline-flex; align-items:center; gap:6px;">
                        ...
                        <span style="display:inline-flex; align-items:center; gap:6px;">
                            <span style="width:12px; height:12px; border-radius:50%; background:#f44336; display:inline-block;"></span>
                            Full
                        </span>
                    </div>
                </div>
                        ...
                        fetch(url)
                            ...
                            .then(data => {
                                ...
                                data.forEach(slot => {
                                    ...
                                    btn.type = 'button';
                                    btn.textContent = `${slot.orario} (${slot.occupati}/${slot.max})`;
                            ...
                            .then(data => {
                                ...
                                calendarEl.querySelectorAll('button[data-date]').forEach(dayEl => {
                                    ...
                                    dayEl.addEventListener('click', function () {
                                        ...
                                        this.style.outline = '3px solid rgba(0,0,0,.18)';
